...
const web3 = new Web3(ganache.provider()); //local ganache network
...
beforeEach(async () => {
    accounts = await web3.eth.getAccounts(); //10 accounts created by ganache
    //deploy new campaign factory ABI
